                ...
                <li>
                    ...
                    <div class="collapse" id="Advante_Salary">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a href="#advance_salary" data-bs-toggle="collapse">
                                    Tạm ứng lương <span class="menu-arrow"></span>
                                </a>
                                <div class="collapse" id="advance_salary">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="{{ route('add.AdvanceSalary') }}">Thêm lương tạm ứng</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('all.AdvanceSalary') }}">Bảng lương tạm ứng</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li>
                                <a href="#pay_salary" data-bs-toggle="collapse">
                                    Trả lương <span class="menu-arrow"></span>
                                </a>
                                <div class="collapse" id="pay_salary">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="{{ route('all.PaySalary') }}">Bảng chi trả lương tháng</a>
                                        </li>
