<div class="navbar-custom">
    <div class="container-fluid">
        <ul class="list-unstyled topnav-menu float-end mb-0">
            ...
            <!-- Tìm form Desktop/Laptop-->
            <li class="d-none d-lg-block">
                <form class="app-search">
                    <div class="app-search-box dropdown">
                        <div class="input-group">
                            <input type="search" class="form-control" placeholder="Tìm..." id="top-search">
            ...
            <li class="dropdown d-inline-block d-lg-none">
                ...
                <div class="dropdown-menu dropdown-lg dropdown-menu-end p-0">
                    <form class="p-3">
                        <input type="text" class="form-control" placeholder="Tìm on Mobile..." aria-label="Recipient's username">
                    </form>
                </div>
            </li>
...
@endphp
            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src="{{ (!empty($user->photo)) ? url($user->photo) : url('backend/upload/no_image.jpg') }}" alt="user-image" class="rounded-circle">
