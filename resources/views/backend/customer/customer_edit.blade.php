    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="mdi mdi-home-outline"></i>
                            </a></li>
        ...
        <div class="row">
            <div class="col-lg-8 col-xl-8">
                <div class="card">
                    <div class="card-body">
                        <form id="update_customer_form" method="POST" action="{{ route('update.customer') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 form-group">
                                        ...
                                        <img id="showImage" src="{{  (!empty($customer->image)) ? url($customer->image) : url('backend/upload/no_image.jpg') }}" class="rounded-circle avatar-lg img-thumbnail"
