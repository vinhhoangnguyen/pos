    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-8 col-xl-8">
                <div class="card">
                    <div class="card-body">
                        <form id="add_employee_form" method="POST" action="{{ route('store.employee') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 form-group">
                                        ...
                                        <input type="text" name="vacation" class="form-control @error('vacation') is-invalid @enderror"  value="{{ old('vacation') }} " >
                                        @error('vacation')
                                            <span class="text-danger"> {{ $message }} </span>
                                        @enderror
                                    </div>
