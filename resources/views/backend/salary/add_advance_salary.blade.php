    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('all.AdvanceSalary') }}">Quản lý lương tạm ứng</a></li>
                            <li class="breadcrumb-item active">Tạm ứng lương nhân viên</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Tạm ứng lương nhân viên</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-lg-8 col-xl-8">
                <div class="card">
                    <div class="card-body">
                        <form id="add_employee_form" method="POST" action="{{ route('store.AdvanceSalary') }}" >
                        @csrf

                            <div class="row">
                                <div class="col-md-5">
                                    <div class="mb-3 form-group">
                                        <label class="form-label">Ngày ứng(tháng/ngày/năm)</label>
                                        <input type="date" name="advance_date" class="form-control @error('advance_date') is-invalid @enderror " value="{{ date('Y-m-d') }}">
                                        @error('advance_date')
