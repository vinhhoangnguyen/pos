    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12 col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <form id="add_supplier_form" method="POST" action="{{ route('store.supplier') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3 form-group">
                                        ...
                                        <input type="text" name="contact_sale" class="form-control @error('contact_sale') is-invalid @enderror" value="{{ old('contact_sale') }}" >
                                        @error('contact_sale')
                                            <span class="text-danger"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3 form-group">
                                        ...
                                        <input type="text" name="warranty_phone" class="form-control @error('warranty_phone') is-invalid @enderror" value="{{ old('warranty_phone') }}" >
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3 form-group">
                                        ...
                                        <input type="text" name="warranty_address" class="form-control @error('warranty_address') is-invalid @enderror" value="{{ old('warranty_address') }}" >
