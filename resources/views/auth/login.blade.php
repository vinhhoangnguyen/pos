...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Đăng nhập | Trí Đức Shop</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Trí Đức - Laptop - Camera - Máy tính - Máy in - Phụ kiện" name="description" />
        <meta content="TriDuc" name="author" />
    ...
    <body class="authentication-bg authentication-bg-pattern">
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4">
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="mb-3">
                                        <label for="emailaddress" class="form-label">Email/Số điện thoại/Tên</label>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                ...
                                <p class="text-white-50">Đã có tài khoản chưa? <a href="auth-register.html" class="text-white ms-1"><b>Đăng ký</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
        ...
        <footer class="footer footer-alt">
            2010 - <script>document.write(new Date().getFullYear())</script> &copy;  <a href="" class="text-white-50">Trí Đức Shop</a> 
        </footer>
